...
namespace IIS.ISS3
{
    ...
    public class РабочееМесто : ICSSoft.STORMNET.DataObject
    {
        ...
        public virtual IIS.ISS3.DetailArrayOfОборудование Оборудование
        {
            get
            {
                ...
                {
                    this.fОборудование = new IIS.ISS3.DetailArrayOfОборудование(this);
                }
                IIS.ISS3.DetailArrayOfОборудование result = this.fОборудование;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View РабочееМестоE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РабочееМестоE", typeof(IIS.ISS3.РабочееМесто));
                }
            }
            ...
            public static ICSSoft.STORMNET.View РабочееМестоL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РабочееМестоL", typeof(IIS.ISS3.РабочееМесто));
                }
            }
        }
    }
